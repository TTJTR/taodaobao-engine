...
def test_enterprise_evidence_matching_supports_backend_uuid_asset_ids() -> None:
    ...
    candidates = build_evidence_candidates([draft], snapshot)

    assert _compatible_evidence_ids(draft, candidates) == {candidates[0].evidence_id}
